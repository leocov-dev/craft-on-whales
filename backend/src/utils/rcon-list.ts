...
// silently drift apart, as happened here. This only unifies the parsing: a
// null return still means "couldn't read player counts", and each caller
// decides for itself what that implies. Ported verbatim from
// src/utils/rconList.ts.

import { PLAYER_NAME_RE } from './player-name';
