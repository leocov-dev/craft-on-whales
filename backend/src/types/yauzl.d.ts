...
// (yauzl is pinned at 3.4.0 in package.json) — same API shape for the
// callback-based open/fromBuffer + lazyEntries walk this codebase uses, so a
// minimal hand-rolled declaration beats installing a mismatched-major
// @types package. Mirrors the legacy repo's types/yauzl.d.ts verbatim.
