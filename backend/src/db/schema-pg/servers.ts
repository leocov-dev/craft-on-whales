// Postgres mirror of ../schema/servers.ts — see ./PG_SCHEMA_NOTES.md for the
...
export const serverPacks = pgTable('server_packs', {
...
export const serverContent = pgTable(
  'server_content',
  {
    ...
    serverId: text('server_id')
      .notNull()
      .references(() => servers.id, { onDelete: 'cascade' }),
    libraryId: text('library_id'), // references library_files.id — see schema-pg/library.ts
