CREATE TABLE "server_content" (
	...
	"installed_at" text DEFAULT now() NOT NULL
);
...
CREATE TABLE "servers" (
	...
	"quota_strict" boolean DEFAULT false NOT NULL,
	...
	"container_id" text,
	"pending_recreate" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "user_server_permissions" (
	...
	CONSTRAINT "user_server_permissions_pkey" PRIMARY KEY("user_id","server_id")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" text PRIMARY KEY,
...
CREATE TABLE "integrations" (
	...
	CONSTRAINT "integrations_pkey" PRIMARY KEY("server_id","kind")
);
--> statement-breakpoint
CREATE TABLE "api_cache" (
	"key" text PRIMARY KEY,
	"value_json" text NOT NULL,
	"fetched_at" text DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "update_checks" (
	...
	CONSTRAINT "update_checks_pkey" PRIMARY KEY("subject_type","subject_id")
);
--> statement-breakpoint
...
CREATE INDEX "idx_backups_server" ON "backups" ("server_id","created_at");--> statement-breakpoint
ALTER TABLE "server_content" ADD CONSTRAINT "server_content_server_id_servers_id_fkey" FOREIGN KEY ("server_id") REFERENCES "servers"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "server_packs" ADD CONSTRAINT "server_packs_server_id_servers_id_fkey" FOREIGN KEY ("server_id") REFERENCES "servers"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "user_server_permissions" ADD CONSTRAINT "user_server_permissions_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "crash_reports" ADD CONSTRAINT "crash_reports_event_id_events_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("id");--> statement-breakpoint
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_server_id_servers_id_fkey" FOREIGN KEY ("server_id") REFERENCES "servers"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "backups" ADD CONSTRAINT "backups_server_id_servers_id_fkey" FOREIGN KEY ("server_id") REFERENCES "servers"("id") ON DELETE CASCADE;