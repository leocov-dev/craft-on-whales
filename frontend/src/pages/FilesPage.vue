<template>
  <q-page class="q-pa-md">
    <PageHeader title="Files" icon="folder">
      <template #action>
    ...
    <div class="row items-center q-gutter-x-xs q-mb-sm text-caption">
      <a href="#" class="text-primary" @click.prevent="navigate('')">data</a>
    ...
    <q-dialog v-model="editorOpen">
      <q-card bordered class="shadow-12" style="min-width: 600px; max-width: 90vw; width: 100%">
