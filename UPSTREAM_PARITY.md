...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0.13.2 `77c77aa` `5d87d21` `c890921`           | `server.properties` edits survive a restart (#39)                                                                 | Planned | —      | The itzg image re-applies env-backed properties on every start. One write choke point must also clear the matching env var and flag a recreate. `world-props.service.ts` does not do this today. |
...
| 0.13.1 `4fe33fc` `86a0d4f`                     | Heap size fields reach Java in megabytes (#25)                                                                    | Planned | —      | Bare numbers are bytes to Java. Also explain the up-front heap on the memory meters.                                                                                                             |
